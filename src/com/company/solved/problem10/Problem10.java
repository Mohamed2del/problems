...
//        Constructor<?> c = Class.forName("com.company.solved.problem10."+childClass).getDeclaredConstructor(constructorParam.getClass());
//
//        c.setAccessible(true);
//        c.newInstance(new Object[]{constructorParam});
//
////        Class s = Class.forName("com.company.solved.problem10."+childClass);
//        Object z = s.getDeclaredConstructor(constructorParam.getClass()).newInstance(constructorParam);


        Class<?> clazz = Class.forName("com.company.solved.problem10."+className);
        Class[] param = null;
